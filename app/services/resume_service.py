...
<<<<<<< HEAD
async def analyze_resume_with_ai(resume_text: str = None, file_data: bytes = None, mime_type: str = None):
    """
    Sends the resume content (text or file bytes) to Gemini to score, extract skills, and find improvements.
=======
...
<<<<<<< HEAD
    ...
    if file_data and mime_type:
        ...
        Analyze the attached resume file and provide a deep, highly structured analysis for the user.
    ...
    return await generate_ai_response(prompt, system_instruction, mock_response=mock, file_data=file_data, mime_type=mime_type)
=======
    prompt = f"""
    You are an expert technical recruiter and AI resume reviewer.
    Read the following resume and provide a deep, highly structured analysis for the user.
